...
g_f
# ggsave(filename = "Fig6.tiff", plot = g_f, device = "tiff", path = "../paper_materials/supplemental/", dpi = 600, units = "in", width = 7, height = 5, scale = 2, compression = "lzw")
```
...
g_f <- ggarrange(g1, g2,  
          ...
          font.label = list(size = 10, color = "black", face ="bold"))
g_f
# ggsave(filename = "Fig5.tiff", plot = g_f, device = "tiff", path = "../paper_materials/supplemental/", dpi = 600, units = "in", width = 7, height = 5, scale = 2, compression = "lzw")
...
# ggsave(filename = "Fig7.tiff", plot = g_f1, device = "tiff", path = "../paper_materials/supplemental/", dpi = 600, units = "in", width = 6, height = 5, scale = 2, compression = "lzw")
```
