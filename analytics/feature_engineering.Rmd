...
all_results_reshaped_plot$variable1[all_results_reshaped_plot$variable == "base_with_higher_level_feats_diff"] <- "base and aggregates"
all_results_reshaped_plot$variable1[all_results_reshaped_plot$variable == "base_with_maximums_diff"] <- "base and maximums"     
all_results_reshaped_plot$variable1[all_results_reshaped_plot$variable == "base_with_binary_flags_diff"] <- "base and binary flags"     
...
all_results_reshaped_plot$variable1[all_results_reshaped_plot$variable == "binary_with_maximums_diff"] <- "maximums"
all_results_reshaped_plot$variable1[all_results_reshaped_plot$variable == "binary_flags_diff"] <- "binary flags"
...
g_f
# ggsave(filename = "Fig1.tiff", plot = g_f, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2, compression = "lzw")
