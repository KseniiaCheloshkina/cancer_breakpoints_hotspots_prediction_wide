...
g1
# ggsave(filename = "Fig17.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 4, height = 5, scale = 2, compression = "lzw")
```
...
# ggsave(filename = "Fig19_sum.tiff", plot = g2, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2.2, compression = "lzw")
g2
```
...
by_f_canc <- by_f_canc %>%
  inner_join(df_feat_proper, by=c("new_feature"="feature")) %>%
  inner_join(proper_feature_group_names, by=c("feature_group"="feature_group_name"))
...
g1 <- ggplot(by_f_canc_plot, aes(x=variable, y=total_sets, color=new_feature, group=new_feature))+
  ...
  labs(color="Feature")
g1
# ggsave(filename = "Fig15_med.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2.2, compression = "lzw")
```
...
g1 <- ggplot(by_f_canc_plot, aes(x=variable, y=total_sets, color=new_feature, group=new_feature))+
  ...
  labs(color="Feature")
g1
# ggsave(filename = "Fig15_sum.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2.2, compression = "lzw")
```
