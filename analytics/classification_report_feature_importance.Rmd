...
# ggsave(filename = "Fig20a_99.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2, compression = "lzw")
# ggsave(filename = "Fig20a_995.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2, compression = "lzw")
```
...
# ggsave(filename = "Fig12_1.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
...
# ggsave(filename = "Fig12_2.tiff", plot = g2, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
...
# ggsave(filename = "Fig14_1.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
...
# ggsave(filename = "Fig14_2.tiff", plot = g2, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
...
g_f <- ggarrange(g3, g4,  
          ...
          font.label = list(size = 10, color = "black", face ="bold"))
g_f
# ggsave(filename = "Fig21.tiff", plot = g_f, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
```
...
g_f <- ggarrange(g1, g2,  
          ...
          font.label = list(size = 10, color = "black", face ="bold"))
g_f
# ggsave(filename = "Fig22.tiff", plot = g_f, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2.2, compression = "lzw")
...
g1 <- ggplot(df_onegroup, 
  ...
  labs(fill = "Labeling type")
g1
# ggsave(filename = "Fig8.tiff", plot = g1, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2, compression = "lzw")
```
...
g2 <- ggplot(df_onegroup, 
  ...
  labs(fill = "Labeling type")
g2
# ggsave(filename = "Fig9.tiff", plot = g2, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2, compression = "lzw")

g_f <- ggarrange(g1, g2,  
          labels = c("A", "B"),
          ncol = 1, nrow = 2, heights = c(1, 1),
          font.label = list(size = 10, color = "black", face ="bold"))
# ggsave(filename = "Fig8.5.tiff", plot = g_f, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
```
...
g_f <- ggarrange(g3, g4,  
          ...
          ncol = 1, nrow = 2, heights = c(1, 1),
          font.label = list(size = 10, color = "black", face ="bold"))
# ggsave(filename = "Fig10.tiff", plot = g_f, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 6, height = 5, scale = 2.2, compression = "lzw")
```
