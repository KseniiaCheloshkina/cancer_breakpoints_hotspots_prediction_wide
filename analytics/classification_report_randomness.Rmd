...
g_f
# ggsave(filename = "Fig11.tiff", plot = g_f, device = "tiff", path = "../paper_materials/supplemental/", dpi = 600, units = "in", width = 7, height = 5, scale = 2, compression = "lzw")
```
...
g_f <- ggarrange(g3, g4,  
          ...
          font.label = list(size = 10, color = "black", face ="bold"))
g_f
# ggsave(filename = "Fig5a.tiff", plot = g_f, device = "tiff", path = "../paper_materials/supplemental/", dpi = 600, units = "in", width = 7, height = 5, scale = 2, compression = "lzw")
```
