...
```{r}
g2 <- ggplot(best_features, aes(x=cancer_type, y=feature_ord, fill=feature_group))+
  geom_tile() + 
  scale_fill_jco() +
  theme(
      text = element_text(size = 8, family = "arial"),
...
# ggsave(filename = "Fig4.tiff", plot = g2, device = "tiff", path = "../paper_materials/", dpi = 600, units = "in", width = 5, height = 3, scale = 2, compression = "lzw")
```
